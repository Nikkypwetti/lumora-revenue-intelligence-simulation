-- Lumora transactional reporting refresh
-- Generated from 006_transform_to_reporting.sql
-- The CALL executes as one PostgreSQL transaction.

CREATE OR REPLACE PROCEDURE transformation.refresh_reporting()
LANGUAGE plpgsql
SECURITY DEFINER
...
REVOKE ALL
ON PROCEDURE transformation.refresh_reporting()
FROM PUBLIC;

GRANT EXECUTE
ON PROCEDURE transformation.refresh_reporting()
TO lumora_transform_rw;
